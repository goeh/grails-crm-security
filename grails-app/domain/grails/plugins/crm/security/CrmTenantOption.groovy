 ...
 */
class CrmTenantOption<T> {
    String key
    String v
    static belongsTo = [tenant:CrmTenant]
    static constraints = {
    ...
    CrmTenantOption(String key, Object value) {
        this.key = key
        this.setValue(value)
    }

    CrmTenantOption(Long tenant, String key, Object value) {
        this.tenant = CrmTenant.load(tenant)
        this.key = key
        this.setValue(value)
    }
